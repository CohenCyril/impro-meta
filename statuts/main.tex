...
\makeatletter
\newcommand{\sfranky@subsection}{\thesubsection}
\newcommand{\sfranky@section}{\thesection}
...
qui statue, selon les modalités prévues par le \RI{}, sur les demandes d'admission présentées. Il faut alors adhérer aux présents
\statuts{} et au \RI{} et s’acquitter de la cotisation dont le montant est fixé par ce dernier.
...
\article{La Troupe}
\label{sec:troupe}
Un collège de membres appelé \textit{\troupe{}} est chargé de l'organisation des spectacles de l'association. Les représentations de ces spectacles sont données par \troupe{}. Le fonctionnement de ce collège est fixé par le \RI{}.
...
\label{sec:projet}
Suite à la réflexion menée suivant les conditions de l'\artref{sec:reflexions}, le \bureau{} définira les orientations artistiques pour \troupe{}. Il confiera l'établissement et la réalisation d'un projet artistique suivant ces orientations au \DA{} de \troupe{}. Ce projet devra comprendre au moins un format de spectacle d'improvisation innovant et original.
...
\artref{sec:reflexions}) seront déposés sous licence libre précisé par le \RI{}. Ils seront diffusés sur Internet et tout autre moyen jugé approprié par l'\AG{}.
