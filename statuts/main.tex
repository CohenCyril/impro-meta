...
\label{sec:troupe}
Un collège de membres appelé \og{} La Troupe\fg{} est chargé du montage des spectacles organisés par l'association. Les représentations de ces spectacles sont données par La Troupe. Le fonctionnement de ce collège est fixé par le réglement intérieur.
