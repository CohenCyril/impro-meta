...
régie par la Loi 1901, ayant pour dénomination \meta{} Est une Troupe Associative.
...
Les adhérents peuvent adresser leur correspondance écrite par lettre signée. Alternativement, l'adhérent peut choisir un moyen de communication sécurisé précisé dans le Règlement Intérieur.
...
\label{sec:troupe}
Les représentations des spectacles organisés par l'association sont donnés par un collège de membres appelé \og{}la Troupe\fg{}. Le fonctionnement de ce collège est fixé par le réglement intérieur.
