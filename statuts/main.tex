...
\def\thesubsection       {Article \arabic{article}}
%\let\subsection[1]{\addtocounter{article}{1}\subsection{#1}}

%\let\subsection{\subsection\addtocounter{article}{1}}
...
\label{sec:projet}
Suite à la réflexion menée suivant les conditions de l'\ref{sec:reflexions}, le bureau définira les orientations artistiques pour la Troupe. Il confiera l'établissement et la réalisation d'un projet artistique suivant ces orientations au directeur artistique de la Troupe. Ce projet devra comprendre au moins un format de spectacle d'improvisation innovant et original.
