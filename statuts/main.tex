...
\label{sec:troupe}
Les spectacles organisés par l'association sont donnés par un collège de membres appelé \og{}la Troupe\fg{}. Le fonctionnement de ce collège est fixé par le réglement intérieur.
