...
\article{La Troupe}
\label{sec:troupe}
Un collège de membres appelé \textit{\troupe{}} est chargé de l'organisation des spectacles de l'association. Les représentations de ces spectacles sont données par \troupe{}. Le fonctionnement de ce collège est fixé par l'\artrefri{sec:fonctionnement-troupe}.
