...
régie par la Loi 1901, ayant pour dénomination \meta{}.

\subsection{But}
\label{sec:but}

Cette association a pour but la pratique de l'improvisation théâtrale,
ainsi que la production de spectacles (à titre gratuit ou
rémunéré). L'association organise également des réflexions autour de
l'improvisation, sa pratique, et ses formats, aboutissant à la
diffusion de ces réflexions et de formats innovants et originaux.
...
bénéficient du droit de vote et sont éligibles au conseil
d'administration
% Ajout possible :
...
BY-SA). Ils seront diffusés au moins sur internet.
