...
La Troupe est un collège de membres adhérents chargé d'assuré la représentation des spectacles. La Troupe est composée d'au moins 6 (six) membres adhérents. Lorsque la Troupe est constituée (\textit{i.e.} comporte plus de six (6) membres), tout nouveau recrutement d'un membre dans la Troupe se fera par cooptation à l'unanimité des membres de la Troupe.
Dans le cas contraire, le recrutement se fait à l'unanimité des membres de la Troupe et du Bureau.

 La Troupe se réunit en collège -- pouvant prendre la forme de réunions privées -- au moins une fois tous les 2 (deux) mois.
